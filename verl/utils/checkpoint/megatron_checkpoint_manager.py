...
class MegatronCheckpointManager(BaseCheckpointManager):
    ...
    def load_checkpoint(self, local_path: str, hdfs_path: str = None, del_local_after_load=False):
        ...
        # Loading a HF-backed actor with model-only contents produces an empty
        # distributed state dict.  Do not initialize a distributed checkpoint
        # reader/collective in that case: besides doing no useful work, the
        # multi-gigabyte optimizer-only checkpoint has triggered native worker
        # crashes in the torch-dist fully-parallel loader on resume.
