...
class SeparateRayPPOTrainer(RayPPOTrainer):
    ...
    def _create_critic_class(self):
        ...
        if self.use_critic:
            ...
            if self.orig_critic_cfg.strategy == "fsdp":
            ...
            elif self.orig_critic_cfg.strategy == "megatron":
                from verl.workers.config import McoreEngineConfig

                engine_config: McoreEngineConfig = self.orig_critic_cfg.megatron
                engine_config.infer_max_token_len_per_gpu = critic_cfg.ppo_infer_max_token_len_per_gpu
                engine_config.max_token_len_per_gpu = critic_cfg.ppo_max_token_len_per_gpu
                ...
                engine_config.infer_micro_batch_size_per_gpu = critic_cfg.ppo_infer_micro_batch_size_per_gpu
            else:
