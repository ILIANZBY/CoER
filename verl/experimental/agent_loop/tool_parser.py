...
class Qwen3XMLToolParser(ToolParser):
    ...
    @staticmethod
    def _auto_convert_param(param_value: str) -> Any:
        """Auto-detect and convert parameter values when no schema is available.
        Handles lists, dicts, numbers, booleans."""
        stripped = param_value.strip()
        # Try JSON parse for lists and dicts
    ...
    def _parse_xml_function_call(
        ...
        def convert_param_value(param_value: str, param_name: str, param_config: dict, func_name: str) -> Any:
            ...
            if param_name not in param_config:
                ...
                # No schema info: try to auto-detect lists/dicts/numbers
                return Qwen3XMLToolParser._auto_convert_param(param_value)
            ...
            if param_type in ["string", "str", "text", "varchar", "char", "enum"]:
                ...
                try:
                    ...
                    pass
                # Last resort: wrap single value in a list
                logger.warning(
                    f"Parsed value '{param_value}' of parameter '{param_name}' is not a valid "
                    f"list in tool '{func_name}', wrapping in a list."
                )
                return [param_value]
            else:
        ...
        for match in self.tool_call_parameter_regex.findall(parameters):
            ...
            if ">" not in match_text:
                # Malformed parameter (no separator between name and value), skip
                continue
        ...
        return FunctionCall(name=function_name, arguments=json.dumps(param_dict, ensure_ascii=False, default=str))
