...
def _get_input_embeds(
    ...
    if pixel_values is None and pixel_values_videos is None:
        # Text-only path: skip vision encoder forward entirely to avoid
        # FSDP + gradient checkpoint recompute conflicts in the ViT.
        # No gradient flow needed since vision params don't update in text-only.
        pass
