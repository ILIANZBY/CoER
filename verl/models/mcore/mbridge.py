...
try:
    ...
    # Register the local text-only Qwen3.5 bridge before resolving model configs.
    from verl.models.mcore.qwen3_5_text_bridge import Qwen3_5TextBridge  # noqa: F401
