...
class AgentLoopConfig(BaseConfig):
    ...
    # List of module paths to import for @register decorator activation (e.g., ["cotrain.agent_loop"])
    custom_import_modules: Optional[list] = None
...
class RolloutConfig(BaseConfig):
    ...
    # Limit concurrent standalone replica initialization.  A small value
    # avoids metadata/weight-load storms while eliminating fully serial vLLM
    # cold starts on multi-replica rollout pools.
    standalone_init_concurrency: int = 1
