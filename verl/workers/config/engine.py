...
class VeOmniEngineConfig(EngineConfig):
    ...
    Args:
        ...
        attn_implementation (str): Attention implementation to use.
            ...
            Note: Check the VeOmni documentation for newly supported attention implementations.
        moe_implementation (str): MoE implementation to use.
            1. `eager`
            2. `fused`
            default "fused"
            Note: Check the VeOmni documentation for newly supported MoE implementations.
