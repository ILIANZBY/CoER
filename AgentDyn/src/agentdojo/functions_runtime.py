...
class Function(BaseModel, Generic[P, T]):
    ...
    model_config = {"arbitrary_types_allowed": True, "json_schema_mode_override": "validation"}

    name: str
    """The name of the function."""
    description: str
    """A short description of the function."""
    parameters: type[BaseModel] = Field(exclude=True)
    """The input schema for the function. It is defined as a Pydantic model."""
    dependencies: dict[str, Depends] = Field(exclude=True)
    """A dictionary of dependencies for the function. See [`Depends`][agentdojo.functions_runtime.Depends] for more information."""
    run: Callable[P, T] = Field(exclude=True)
    """The function implementation."""
    full_docstring: str
    """The full docstring of the functions."""
    return_type: Any | None = Field(exclude=True, default=None)
