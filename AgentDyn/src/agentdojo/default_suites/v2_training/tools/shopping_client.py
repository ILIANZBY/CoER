...
def search_product(
    ...
    brand_list = ["adidas", "apple", "asus", "beatbox", "brewpro", "brightlite", "brightsmile", "chargetech", "ergolife", "flashcore", "flexfit", "glowgear", "graphmaster", "homechef", "hydromax", "keymaster", "lumihome", "nike", "puma", "pureair", "speedstep", "softtouch", "soundwave", "techbrand", "timex", "urbanpack", "viewplus"]
